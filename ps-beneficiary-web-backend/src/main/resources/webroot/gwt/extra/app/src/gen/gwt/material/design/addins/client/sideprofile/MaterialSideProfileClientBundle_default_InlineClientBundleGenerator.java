...
public class MaterialSideProfileClientBundle_default_InlineClientBundleGenerator implements gwt.material.design.addins.client.sideprofile.MaterialSideProfileClientBundle {
  ...
  private void sideprofileCssInitializer() {
    sideprofileCss = new com.google.gwt.resources.client.TextResource() {
      // jar:file:/home/rafat/.m2/repository/com/github/gwtmaterialdesign/gwt-material-addins/2.0-rc5/gwt-material-addins-2.0-rc5.jar!/gwt/material/design/addins/client/sideprofile/resources/css/sideprofile.min.css
      public String getText() {
        return ".side-profile span{line-height:0!important}.side-profile i{line-height:1.5}.side-profile .dropProfile i{position:absolute;right:20px}.side-profile{padding:16px}.side-profile a.dropdown-button{cursor:pointer!important;padding:0!important;line-height:3;height:32px!important;font-size:.8em}.side-profile .dropdown-content a{padding:0 15px;height:inherit;line-height:64px}.side-profile img{width:60px;height:60px;margin-bottom:16px;border-radius:100%;-webkit-border-radius:100%;-moz-border-radius:100%}";
      }
